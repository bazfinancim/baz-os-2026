...
export default function VaultPage() {
  ...
  return (
    <div dir={dir} style={{ padding: "24px 26px 40px", maxWidth: "720px", margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.45rem", fontWeight: 800, color: "#0f172a", marginBottom: "10px" }}>{title}</h1>
      <p style={{ color: "#64748b", fontSize: "0.9rem", lineHeight: 1.55, marginBottom: "20px" }}>{body}</p>
      <div
        style={{
          background: "#fff",
      ...
      >
        <code style={{ fontSize: "0.8rem" }}>GET /api/vault</code>
        <span style={{ margin: "0 8px" }}>·</span>
        <code style={{ fontSize: "0.8rem" }}>POST /api/vault/inject</code>
      </div>
    </div>
  );
}
